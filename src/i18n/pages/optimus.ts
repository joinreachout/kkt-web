...
export const OPTIMUS: Record<Locale, OptimusDict> = {
  ...
  th: {
    ...
    defPre: 'ผู้ใช้คือหัวหน้าฝ่ายจัดหา เวิร์กโฟลว์ตอนเช้าใช้เวลา 10 ถึง 15 นาที: อ่านบรีฟ ปิดตำแหน่งวิกฤต ยืนยันหรือปรับคำแนะนำ ออกใบสั่งซื้อ Optimus อยู่ระหว่างนำร่องที่ Red Petroleum — เครือข่ายปั๊มน้ำมันอิสระในคีร์กีซสถาน ราว 250 สถานี เป็นตัวอย่างหนึ่งของวิธีที่เราทำงานในธุรกิจน้ำมัน: เอนจินการจัดซื้อและมาร์จินบนข้อมูลที่เชื่อมโยงกัน — เศรษฐกิจของเครือข่ายในภาพกว้างอยู่ที่',
