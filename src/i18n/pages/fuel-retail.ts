...
export const FUEL: Record<Locale, FuelDict> = {
  ...
  th: {
    meta: { title: 'ค้าปลีกน้ำมัน — KKT', description: 'AI และข้อมูลสำหรับเครือข่ายปั๊มน้ำมันอิสระ — การจัดซื้อและมาร์จิน โลจิสติกส์ สถานี ลูกค้า การเงินและการควบคุม สร้างจากล่างขึ้นบน บนข้อมูลที่คุณมีอยู่แล้ว' },
    introLabel: 'อุตสาหกรรม — ค้าปลีกน้ำมัน', h1a: 'สำหรับ', h1grad: 'เครือข่ายปั๊มน้ำมันอิสระ',
    lede: 'เครือข่ายของคุณมีข้อมูลอยู่แล้ว — ERP, POS, ระบบสะสมแต้ม, GPS, คลังน้ำมัน, BI, สเปรดชีต สิ่งที่มักขาดไปคือความเชื่อมโยงกัน: เครือข่ายเดินด้วยคน การโทร การกระทบยอดด้วยมือ และประสบการณ์ของผู้จัดการแต่ละคน ในขณะที่ข้อมูลที่กองรวมกันไว้ยังไม่ได้ทำงานเพื่อการตัดสินใจของคุณ',
    imgAlt: 'ลานหน้าปั๊มน้ำมันในยามพลบค่ำ', imgLabel: 'น้ำมัน — ลานหน้าปั๊ม คลังน้ำมัน หรือทั้งเครือข่ายในภาพเดียว',
    pathLabel: 'เส้นทางเดินอย่างไร', pathTitle: 'AI ได้ที่ทางของมันบนรากฐาน — เส้นทางจึงไปจากล่างขึ้นบน',
    pathLede: 'AI agents ไม่ได้ติดตั้งบนความวุ่นวาย ทุกบล็อกของเศรษฐกิจเครือข่ายไต่ขึ้นด้วยวิธีเดียวกัน — เริ่มเล็ก ๆ บนข้อมูลที่คุณมีอยู่แล้ว แล้วสร้างรากฐานไปพร้อมกัน คุณไม่จำเป็นต้องอยู่จุดสูงสุดจึงจะเริ่มได้',
    stages: [
      { tag: 'ระยะที่ 1', name: 'โซลูชันพื้นฐาน', body: 'เริ่มได้เร็วบนข้อมูลที่คุณมีอยู่แล้ว เห็นผลชัดโดยไม่ต้องเปลี่ยนกระบวนการมาก' },
      { tag: 'ระยะที่ 2', name: 'โซลูชันขั้นสูง', body: 'ต้องการข้อมูล การเชื่อมต่อ และโมเดลที่พร้อมมากขึ้น ให้ผลมากขึ้นจากการเพิ่มประสิทธิภาพการตัดสินใจและกระบวนการ' },
      { tag: 'ระยะที่ 3', name: 'โซลูชันเชิงเอเจนต์และเชิงระบบ', body: 'โซลูชันครบวงจรและ AI agents ที่ทำงานบนรากฐาน คนเป็นผู้กำหนดกฎและควบคุมผลลัพธ์' },
    ],
    startsLabel: 'จุดเริ่มต้นของการทำงานร่วมกัน', startsTitle: 'ครอบคลุมทั้งเศรษฐกิจของเครือข่าย',
    startsLede: 'ผลลัพธ์กระจายทั่วทั้งเศรษฐกิจของเครือข่าย — การจัดซื้อและมาร์จิน การตั้งราคา โลจิสติกส์ สถานี การเงินและการควบคุม เราเริ่มจากจุดที่การวิเคราะห์ชี้ไป',
    blocks: [
      { lever: 'น้ำมัน: การจัดซื้อ ราคา และมาร์จิน', detail: 'การจัดซื้อและราคาเดินเป็นวงจรการค้าเดียวกัน — พยากรณ์ความต้องการ เลือกผู้จำหน่ายและจังหวะเวลา คิดต้นทุนรวมถึงปลายทางของแต่ละล็อต ตั้งราคาหน้าปั๊มตามตลาดและอุปสงค์', tasks: ['ซื้อน้ำมันในปริมาณที่เหมาะสมในจังหวะที่เหมาะสม', 'เลือกผู้จำหน่ายและเงื่อนไขการซื้อ', 'คิดต้นทุนรวมถึงปลายทางของแต่ละล็อต', 'ตั้งราคาตามตลาดและอุปสงค์'] },
      { lever: 'โลจิสติกส์และการจัดหาน้ำมัน', detail: 'ทำให้การจัดหาน้ำมันจัดการได้ครบวงจร — การเคลื่อนย้ายล็อต ความเสี่ยงล่าช้า ส่วนต่างตอนรับสินค้า ตู้รถไฟและค่าจอดเทียบ การดำเนินงานคลัง การส่งถึงสถานี การเดินรถ', tasks: ['ติดตามการเคลื่อนย้ายล็อตและความเสี่ยงล่าช้า', 'หาจุดที่สูญเสียจากส่วนต่างการจัดหา', 'ควบคุมตู้รถไฟและค่าจอดเทียบ', 'วางแผนการส่งน้ำมันไปยังสถานี'] },
      { lever: 'สถานี ร้านค้า และคาเฟ่', detail: 'บริหารสถานีเป็นจุดทำกำไร ไม่ใช่แค่หน่วยปฏิบัติการ — สถานีที่ทำได้ต่ำกว่าเป้า คิวและทราฟฟิกที่หลุดไป การทุจริตที่ตู้จ่ายและ POS การจัดกะ อุปกรณ์ การจัดสินค้า การเปลี่ยนทราฟฟิกเป็นยอดร้าน', tasks: ['เข้าใจว่าทำไมสถานีทำได้ต่ำกว่าเป้า', 'หยุดการสูญเสียที่ตู้จ่ายและที่แคชเชียร์', 'ทำให้อุปกรณ์สถานีพร้อมใช้งาน', 'เปลี่ยนทราฟฟิกน้ำมันเป็นยอดซื้อในร้าน'] },
      { lever: 'ลูกค้า ระบบสะสมแต้ม และ B2B', detail: 'เปลี่ยนฐานลูกค้าและพอร์ต B2B ให้เป็นแหล่งเติบโตที่บริหารได้ — คุณค่าลูกค้า การเลิกใช้ (churn) ความถี่และยอดต่อบิล โปรโมชัน รีวิว retail media ความสามารถในการทำกำไรของลูกค้าองค์กร', tasks: ['เข้าใจลูกค้าและเศรษฐศาสตร์ของเขา', 'รักษาลูกค้าและป้องกันการเลิกใช้', 'เพิ่มความถี่ ยอดต่อบิล และสัดส่วนที่ไม่ใช่น้ำมัน', 'จัดและวัดผลโปรโมชัน'] },
      { lever: 'การเงิน เงิน และการควบคุม', detail: 'การเงินเห็นธุรกิจเป็นภาพสด ๆ และหาสาเหตุของความคลาดเคลื่อนได้เร็วขึ้น — มาร์จิน ต้นทุน เงินสด ลูกหนี้ ความเสี่ยงการชำระเงิน การสูญเสียทางการเงินและการฝ่าฝืนนโยบาย มองเห็นได้ตั้งแต่เนิ่น ๆ', tasks: ['เห็นภาพการเงินตรงนี้ตอนนี้', 'เข้าใจสาเหตุของความคลาดเคลื่อน ไม่ใช่แค่ข้อเท็จจริง', 'คาดการณ์ช่องว่างเงินสดและกระแสเงินสด', 'เผยการสูญเสียทางการเงินและส่วนต่าง'] },
      { lever: 'ฟังก์ชันสนับสนุน', detail: 'ตัดงานประจำออกและเสริมการควบคุมในฟังก์ชันที่สนับสนุนธุรกิจ — HR กฎหมาย การจัดซื้อ MTO ผู้รับเหมา การควบคุมภายใน เอกสารและงานหลังบ้าน', tasks: ['HR และกำลังคน', 'กฎหมาย', 'การจัดซื้อ MTO และผู้รับเหมา', 'การควบคุมภายใน การสูญเสีย และความเสี่ยง'] },
      { lever: 'ข้อมูลและกระบวนการ — รากฐาน', detail: 'รากฐานที่การวิเคราะห์ ระบบอัตโนมัติ และ AI ทำงานอยู่บนนั้น — ฐานข้อมูลเดียว คุณภาพและความพร้อมใช้ การรายงาน การค้นหาความรู้ เครื่องมือ AI สำนักงาน การรื้อออกแบบกระบวนการ และโซลูชันเชิงเอเจนต์', tasks: ['แหล่งความจริงเดียว แทนตัวเลขที่ต่างกันในแต่ละแผนก', 'หาคำตอบจากองค์ความรู้ของบริษัท', 'ยกงานประจำออกจากทีม'] },
    ],
    tailMap: 'ดูแผนการทรานส์ฟอร์มฉบับเต็ม', tailCase: 'อ่านเคส Red Petroleum',
    hwwLabel: 'วิธีการทำงานของเรา', hwwTitle: 'สร้างขึ้นรอบเศรษฐศาสตร์ธุรกิจของคุณ',
    hww: [
      { k: 'จากชัยชนะเร็ว ๆ สู่การทรานส์ฟอร์มเชิงระบบ', p: 'เริ่มจากเคสการใช้งานที่ชัดเจน แล้วสร้างข้อมูล กระบวนการ โมเดล และระบบเชิงเอเจนต์ที่อยู่เบื้องหลัง' },
      { k: 'AI ผูกกับเศรษฐศาสตร์ธุรกิจ ไม่ใช่เทคโนโลยีตามกระแส', p: 'ทุกโครงการตอบต่อมาร์จิน การสูญเสีย เงินทุนหมุนเวียน รายได้ บริการ หรือประสิทธิภาพของทีม' },
      { k: 'เราเดินไปด้วยกันตั้งแต่ไอเดียจนถึงการใช้งานจริง', p: 'เรากำหนดลำดับความสำคัญ ข้อมูล สิ่งที่เกี่ยวเนื่อง โครงการนำร่อง และก้าวถัดไปที่เป็นจริงได้สำหรับเครือข่ายของคุณ' },
    ],
    ctaHeading: 'วิเคราะห์เครือข่ายปั๊มน้ำมัน สองสัปดาห์', ctaBody: 'สองสัปดาห์เพื่อหาว่าข้อมูลและ AI จะขยับตัวเลขในเครือข่ายของคุณได้ที่ไหน — การจัดซื้อ โลจิสติกส์ สถานี การเงิน — และควรสร้างอะไรก่อน',
  },
};
