...
export const HOME: Record<Locale, HomeDict> = {
  ...
  th: {
    maps: {
      ...
      lede: 'AI Transformation Maps ที่สร้างขึ้นสำหรับอุตสาหกรรมที่เราเชี่ยวชาญลึกที่สุด:',
      retail: 'Retail AI Canvas', retailArrow: 'ครอบคลุมทั้งธุรกิจค้าปลีก →',
      fuel: 'Fuel AI Transformation Map', fuelArrow: 'ทั้งระบบเศรษฐกิจของเครือข่ายปั๊มน้ำมัน →',
    },
    how: {
      label: 'วิธีการทำงานของเรา',
      title: 'จากคำถามสู่โซลูชันที่ส่งมอบได้จริง',
      intro: 'สี่ขั้นตอน จากโจทย์ธุรกิจสู่โซลูชันที่ทำงานได้จริง จุดเริ่มต้นคือเป้าหมายหรือการตัดสินใจที่ต้องปรับปรุงเสมอ — เทคโนโลยีตามมาทีหลัง',
      steps: [
        { n: '01', title: 'ระบุและประเมิน', lead: 'เราทำให้โจทย์ธุรกิจชัดเจน เข้าใจสถานการณ์ปัจจุบัน และประเมินว่า AI ข้อมูล การวิเคราะห์ ระบบอัตโนมัติ หรือการออกแบบกระบวนการใหม่ ช่วยได้จริงหรือไม่', outputs: ['เห็นภาพชัดของโจทย์ธุรกิจ ผู้รับผิดชอบ และผลลัพธ์ที่คาดหวัง', 'ตรวจสอบเบื้องต้นถึงข้อมูลที่มี สภาพจริงของกระบวนการ และความเป็นไปได้', 'ข้อเสนอแนะว่าจะเดินหน้าต่อ ปรับแนวคิด หรือหยุดตั้งแต่ต้น'] },
        { n: '02', title: 'กำหนดขอบเขตและเตรียมการ', lead: 'เราเปลี่ยนโอกาสที่น่าสนใจให้เป็นโปรเจกต์ที่พร้อมลงมือ ซึ่งทั้งทีมธุรกิจและทีมเทคนิคเข้าใจตรงกัน', outputs: ['สิ่งที่ต้องเปลี่ยนในกระบวนการและการไหลของการตัดสินใจ', 'ข้อมูล ระบบ คน และกฎเกณฑ์ที่ต้องใช้', 'แผนการส่งมอบพร้อมข้อกำหนด ผู้รับผิดชอบ และเกณฑ์การตรวจรับ'] },
        { n: '03', title: 'ลงมือทำและประสานงาน', lead: 'เราสนับสนุนการลงมือทำจากฝั่งธุรกิจ และทำให้การส่งมอบทางเทคนิคเชื่อมโยงกับผลลัพธ์ทางธุรกิจ', outputs: ['ประสานงานระหว่างฝ่ายธุรกิจ ผู้ให้บริการ และทีมเทคนิค', 'ตรวจสอบสม่ำเสมอว่าโซลูชันยังแก้โจทย์ธุรกิจอยู่', 'การทดสอบ การตรวจรับ การจัดแนวผู้มีส่วนได้ส่วนเสีย และการสนับสนุนการนำไปใช้'] },
        { n: '04', title: 'ปิดงาน นำไปใช้ และขยายผล', lead: 'เราช่วยให้โซลูชันใช้งานได้จริง วัดผลได้ และพร้อมปรับปรุงต่อ', outputs: ['โซลูชันที่ทำงานได้ ฝังอยู่ในกระบวนการธุรกิจ', 'การส่งมอบ การนำไปใช้โดยผู้ใช้ และการติดตามคุณค่า', 'ขั้นตอนถัดไปที่ชัดเจนสำหรับการขยายผลหรือปรับปรุงโซลูชัน'] },
      ],
    },
    why: {
      label: 'ทำไมต้องเรา',
      title: 'เราอยู่ข้างเดียวกับเจ้าของธุรกิจ',
      intro: 'ทีมงานอาวุโสที่มีรากฐานจากธุรกิจ ไม่ใช่แค่เทคโนโลยี — งานจึงถูกกำหนดด้วยสิ่งที่ขับเคลื่อนธุรกิจ และสร้างให้ทำงานต่อได้แม้เราถอนตัวไปแล้ว',
      points: [
        { title: 'AI ผูกกับเศรษฐศาสตร์ของธุรกิจ', body: 'ทุกโครงการผูกกับมาร์จิน การสูญเสีย เงินทุนหมุนเวียน รายได้ บริการ หรือประสิทธิภาพของทีม — ไม่ใช่ตามกระแสเทคโนโลยี' },
        { title: 'ชนะเร็วก่อน แล้วค่อยสร้างระบบ', body: 'เราเริ่มจากเคสการใช้งานที่ชัดเจน แล้วสร้างข้อมูล กระบวนการ โมเดล และเอเจนต์ต่อยอดขึ้นไป' },
        { title: 'ประสบการณ์ระดับโลก บริบทของคุณ', body: 'เรานำแนวปฏิบัติสากลมาใช้ แต่คำนึงถึงความพร้อมของข้อมูล ความพร้อมของระบบ ข้อจำกัดในการดำเนินงาน และสภาพจริงในพื้นที่' },
        { title: 'จากไอเดียสู่การลงมือทำ', body: 'เรากำหนดลำดับความสำคัญ ข้อมูล สิ่งที่เกี่ยวเนื่อง โครงการนำร่อง และก้าวถัดไปที่เป็นจริงได้สำหรับธุรกิจของคุณ' },
      ],
    },
    cases: {
      ...
      items: [
        { id: 'click-grow', focus: 'การวิเคราะห์ลูกค้าสำหรับแบรนด์สวนอัจฉริยะแบบ D2C', sector: 'ฮาร์ดแวร์ผู้บริโภค · D2C', what: 'การวิเคราะห์ลูกค้า การแบ่งกลุ่ม และการปรับให้เฉพาะบุคคล บนพื้นฐานพฤติกรรมการใช้อุปกรณ์และวัสดุสิ้นเปลือง', scope: ['การวิเคราะห์และแบ่งกลุ่มลูกค้าทั่วทั้งฐาน D2C', 'พฤติกรรมการซื้อผสานกับสัญญาณการมีส่วนร่วมกับผลิตภัณฑ์', 'การสนับสนุนการปรับเฉพาะบุคคลเพื่อการรักษาลูกค้าและการตลาดตลอดวงจรชีวิต'], outcome: ['พฤติกรรมลูกค้านำไปใช้วางแผนรักษาลูกค้าได้จริง', 'การตลาดตลอดวงจรชีวิตตั้งอยู่บนข้อมูลลูกค้าจริง'] },
        { id: 'csc-telecom', focus: 'การวิเคราะห์ลูกค้า การวิเคราะห์แพ็กเกจ และการสร้างโมเดล churn', sector: 'โทรคมนาคม', what: 'การแบ่งกลุ่มตามพฤติกรรม การสื่อสารเฉพาะบุคคล การวิเคราะห์การตอบสนองต่อแพ็กเกจและโปรโมชัน และโมเดล churn ชุดแรกเพื่อรักษาลูกค้า', scope: ['การแบ่งกลุ่มตามพฤติกรรมและออกแบบการสื่อสารเฉพาะบุคคล', 'การวิเคราะห์โครงสร้างแพ็กเกจและการจัดชุด', 'ประเมินการตอบสนองต่อโปรโมชันตามกลุ่มลูกค้า', 'โมเดล churn ชุดแรกเพื่อนำลูกค้าเสี่ยงเข้าสู่การรักษา'], outcome: ['เห็นกลุ่มเสี่ยงได้เร็วขึ้น ไม่จมหายในภาพรวม', 'การตัดสินใจด้านการตลาดและการค้าบนฐานลูกค้าเดียวกัน'] },
        { id: 'kricon', focus: 'ความโปร่งใสเชิงปฏิบัติการสำหรับโลจิสติกส์ระหว่างประเทศ', sector: 'โลจิสติกส์ระหว่างประเทศ', what: 'โครงสร้างการรายงาน การตรวจจับความผิดปกติ และโมเดลการจัดกลุ่ม ที่เปลี่ยนข้อมูลปฏิบัติการให้เป็นสัญญาณระดับปฏิบัติการ', scope: ['โครงสร้างการรายงานทั่วทั้งการดำเนินงาน', 'การตรวจจับความผิดปกติจากข้อมูลปฏิบัติการ', 'โมเดลการจัดกลุ่มสำหรับสัญญาณระดับปฏิบัติการ'], outcome: ['ปัญหาปฏิบัติการปรากฏเป็นสัญญาณ ไม่ใช่รู้ทีหลัง', 'ฐานการรายงานที่ใช้เดินงานได้จริง'] },
        { id: 'gte', focus: 'การเพิ่มประสิทธิภาพการใช้เชื้อเพลิงในการออกแบบคอมเพรสเซอร์', sector: 'การผลิตอุตสาหกรรม', what: 'การตีกรอบโจทย์ธุรกิจ สถาปัตยกรรมที่ผสาน operations research, ML และกฎวิศวกรรมเชิงกายภาพ การช่วยจัดทีม และการกำกับการพัฒนา', scope: ['การตีกรอบโจทย์ประสิทธิภาพเชื้อเพลิงในการออกแบบคอมเพรสเซอร์', 'สถาปัตยกรรมที่ผสาน OR, ML และกฎวิศวกรรมเชิงกายภาพ', 'ข้อเสนอแนะองค์ประกอบทีม', 'การกำกับดูแลการพัฒนาเชิงเทคนิค'], outcome: ['โมเดลถูกใช้ในงานออกแบบจริง', 'ประสิทธิภาพเชื้อเพลิงที่ดีขึ้นได้รับการยืนยันเทียบกับเกณฑ์วิศวกรรม'] },
        { id: 'forrest-taxi', focus: 'สถาปัตยกรรมและความเป็นไปได้ของการตั้งราคาแบบไดนามิก', sector: 'โมบิลิตี้ · เรียกรถ', what: 'การตีกรอบโจทย์ธุรกิจ สถาปัตยกรรมเป้าหมาย ต้นแบบ ML เพื่อพิสูจน์ความเป็นไปได้ การสนับสนุนผู้ให้บริการที่ลงมือทำ และการควบคุมผลลัพธ์เทียบกับเกณฑ์ฐาน', scope: ['การตีกรอบโจทย์การตั้งราคาในแอป', 'การกำหนดสถาปัตยกรรมเป้าหมาย', 'ต้นแบบ ML เพื่อพิสูจน์ความเป็นไปได้', 'การสนับสนุนการเลือกผู้ให้บริการและกำกับการพัฒนา'], outcome: ['พิสูจน์ความเป็นไปได้ก่อนลงทุนสร้างเต็มรูปแบบ', 'สถาปัตยกรรมเป้าหมายสอดคล้องกับโจทย์ธุรกิจ', 'การนำไปใช้ควบคุมเทียบกับเกณฑ์ฐานที่วัดได้'] },
        { id: 'red-petroleum', focus: 'การทรานส์ฟอร์มด้านข้อมูลและ AI หลายปีทั่วทั้งเครือข่าย', sector: 'ค้าปลีกน้ำมัน', what: 'ความพร้อมด้าน AI และโรดแมป รากฐาน DWH/BI การแบ่งกลุ่มลูกค้า การวิเคราะห์ป้องกันทุจริต ผู้ช่วยภายใน และระบบอัตโนมัติทั้งการชำระเงิน โลจิสติกส์ และการจัดซื้อ', scope: ['โรดแมปและการจัดแนวผู้บริหารสำหรับโครงการข้อมูลและ AI', 'รากฐาน DWH/BI: แดชบอร์ด 24+ ทั่ว 9 แผนก', 'แบ่งกลุ่มสมาชิกสะสมแต้ม 380,000+ ราย; ป้องกันทุจริตกว่า 30 ล้านธุรกรรม', 'เอเจนต์วิเคราะห์ภาษาธรรมชาติ ผู้ช่วย RAG ภายใน ระบบอัตโนมัติการชำระเงิน/โลจิสติกส์ และผลิตภัณฑ์เพิ่มประสิทธิภาพการจัดซื้อชุดแรก', 'จ้างและฝึกอบรมทีมข้อมูลภายในของลูกค้า'], outcome: ['ส่งมอบโรดแมปได้เกือบทั้งหมด', 'ทีมข้อมูลภายในเดินงานได้เองแล้ว', 'รายงานที่เคยใช้เวลาหลายวัน ตอนนี้ใช้เวลาไม่กี่นาที', 'โมเดล ML ภายในชุดแรกขึ้นใช้งานจริง'] },
      ],
    },
    cta: {
      heading: 'มาคุยกันเรื่องโจทย์ธุรกิจของคุณ',
      body: 'บอกเราว่าคุณอยากขยับปัญหาไหน — มาร์จิน ต้นทุน ความพร้อมของสินค้า คุณค่าต่อลูกค้า หรือประสิทธิภาพ เราจะบอกตรง ๆ ว่าข้อมูลและ AI ช่วยได้จริงหรือไม่ และก้าวแรกหน้าตาเป็นอย่างไร',
