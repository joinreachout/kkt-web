...
export const STRINGS: Record<Locale, Dict> = {
  ...
  th: {
    ...
    hero: {
      ...
      titleA: 'เราช่วยให้องค์กรก้าวจาก ', titleAccent1: 'โจทย์ทางธุรกิจ',
      titleB: ' ไปสู่โซลูชันที่ใช้ได้จริงด้าน ', titleAccent2: 'ข้อมูล AI และระบบอัตโนมัติ',
      sub: 'ความเชี่ยวชาญในอุตสาหกรรมและการลงมือทำจริงอยู่ในทีมเดียวกัน — จากโจทย์ธุรกิจสู่โซลูชันที่ทำงานได้จริงในการดำเนินงานของคุณ',
