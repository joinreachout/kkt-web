...
Five named clients. Alfa Oil is featured (the marquee case). The
other four are real shipped work, written up as walkable cases of
varying depth.

## Alfa Oil (Red Petrol) — `/case-studies/alfa-oil`
...
deployment or for proof that the work actually ships at scale, this
is the answer. Full case is in editorial; walkable depth depends on
the consent tier signed.
