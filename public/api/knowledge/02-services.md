...
1. **Margin recovery and assortment.** Where margin is being left on
   the shelf, and what to do about it. Data-grounded, decision-shaped,
   often the fastest line to measurable money in.

2. **Customer ownership.** Segmentation, lifecycle, and the operating
   decisions that follow from knowing who actually drives the business.
   Compounds over time.

3. **Decision cadence.** Pricing, replenishment, cash discipline as a
   daily rhythm rather than a quarterly review. PMO discipline is what
   makes the rhythm hold.

4. **Foundational data and reporting.** When the core is shaky,
