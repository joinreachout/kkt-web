...
PAGES = [
    ('home', 'Operating systems your business runs on.', 'Senior PMO + AI delivery for mid-sized retailers and fuel networks. Tallinn, EU.',
     'In pilot at Red Petroleum — a 220+ station fuel network, Kyrgyzstan.'),
    ...
    ('optimus', 'Optimus.', 'Daily operating intelligence for fuel networks.',
     'In pilot at Red Petroleum — 220+ stations, Kyrgyzstan.'),
    ('alfa-oil', 'Red Petroleum — piloting Optimus across the network.', 'Kyrgyzstan · 220+ station independent fuel network.',
    ...
    ('fuel-retail', 'For fuel networks.', 'Optimus is the operating engine. Around it, four common starting points.',
     'Optimus in pilot at Red Petroleum, Kyrgyzstan.'),
