...
PAGES = [
    ...
    ('optimus', 'Optimus.', 'Daily operating intelligence for fuel networks.',
     'In production at Alfa Oil — 250 stations, Kyrgyzstan.'),
    ('alfa-oil', 'Alfa Oil — Optimus operating across the network.', 'Kyrgyzstan · 250-station independent fuel network.',
    ...
    ('fuel-retail', 'For fuel networks.', 'Optimus is the operating engine. Around it, four common starting points.',
     'Optimus in production at Alfa Oil, Kyrgyzstan.'),
