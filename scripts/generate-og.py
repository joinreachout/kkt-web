...
PAGES = [
    ('home-v2', 'Operating systems your business runs on.', 'Senior PMO + AI delivery for mid-sized retailers and fuel networks. Tallinn, EU.',
     'Data, AI and automation that run in your operations.'),
    ...
    ('optimus-v2', 'Optimus.', 'Daily operating intelligence for fuel networks.',
     'Procurement, distribution and working capital, on connected data.'),
    ('alfa-oil-v2', 'Red Petroleum.', 'Kyrgyzstan · 220+ station independent fuel network.',
    ...
    ('fuel-retail-v2', 'For fuel networks.', 'Optimus is the operating engine. Around it, four common starting points.',
     'Procurement and margin, logistics, stations, customers, control.'),
